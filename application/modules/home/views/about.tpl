		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-3 col-xs-6">
					<div class="who">
						<img src="{$assets_url}/images/ab-1.png" alt="" class="img-responsive who-img">
						<h3>
							We Advance
						</h3>
						<p class="who-detail">
				...
				<div class="col-sm-3 col-xs-6">
					<div class="who">
						<img src="{$assets_url}/images/ab-2.png" alt="" class="img-responsive who-img">
						<h3>
							Helpul Guide
						</h3>
						<p class="who-detail">
				...
				<div class="col-sm-3 col-xs-6">
					<div class="who">
						<img src="{$assets_url}/images/ab-3.png" alt="" class="img-responsive who-img">
						<h3>
							Travel anywhere
						</h3>
						<p class="who-detail">
				...
				<div class="col-sm-3 col-xs-6">
					<div class="who">
						<img src="{$assets_url}/images/ab-4.png" alt="" class="img-responsive who-img">
						<h3>
							our best transport
						</h3>
						<p class="who-detail">
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="story">
						...
						<img src="{$assets_url}/images/client.png" alt="story" class="story-img">
